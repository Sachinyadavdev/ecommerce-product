...
export default function NewPageAdmin() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    setFormData((prev) => {
      ...
      // Auto-generate slug from title if slug was empty or matches old title-slug
    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-heading tracking-tight">Create New Page</h1>
            <p className="text-gray-500 font-medium">Configure site structure and SEO settings</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={() => router.back()}
            className="px-5 py-2 text-gray-600 font-bold hover:bg-gray-100 rounded-xl transition-all text-sm"
          >
            Discard
          </button>
          <button
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-[84px] pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition-all font-medium text-gray-900 text-sm"
                    />
                  </div>
                </div>
              </div>
