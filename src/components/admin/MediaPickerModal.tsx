...
export default function MediaPickerModal({
  ...
  }, [isOpen, page, fetchMedia]);

  useEffect(() => {
    if (isOpen) {
      setTempSelected(selectedUrls);
      // We don't reset to page 1 here automatically to allow keeping their page state if they close/reopen, 
      // but setting tempSelected from props ensures it's fresh when opened.
    }
  }, [isOpen, selectedUrls]);
