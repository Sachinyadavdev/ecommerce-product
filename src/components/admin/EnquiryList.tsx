                  ...
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <button
                        ...
                        className={`px-3 py-1.5 inline-flex items-center gap-2 text-[9px] font-black rounded-lg uppercase tracking-[0.15em] transition-all border ${
                            statusConfig[enquiry.status]?.color?.replace('#61a0b3', '#5e9baf') || "bg-slate-50 border-slate-100"
                        }`}
                      >
