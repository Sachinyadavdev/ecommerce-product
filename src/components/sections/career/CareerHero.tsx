...
export default function CareerHero({ content }: CareerHeroProps) {
  const {
    title = "Careers",
    breadcrumbs = [
      { label: "Home", url: "/" },
    ...
    bannerImage = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=2850"
  } = content || {};
