...
export default function CareerFormSection({ content }: { content?: any }) {
  ...
  const bannerImage = content?.bannerImage || "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=2850";
    ...
    <section className="w-full bg-white relative">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="text-gray-600 space-y-4 text-lg leading-[32px]">
            <p>{content?.line1 || "At Besmak India, we believe our people are our greatest asset and foster a culture of continuous learning."}</p>
            <p>{content?.line2 || "We are constantly looking for passionate individuals who are ready to take on challenges in manufacturing."}</p>
            <p>{content?.line3 || "Whether you are an experienced professional or just starting your career, we offer great growth opportunities."}</p>
            <p>{content?.line4 || "Explore open positions below or submit your resume for future consideration. We'd love to hear from you."}</p>
          </div>
        </div>
