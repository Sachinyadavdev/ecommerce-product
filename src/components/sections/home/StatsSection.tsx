...
export default function StatsSection({ content }: StatsSectionProps) {
  ...
  return (
    <section className={`relative pt-10 pb-20 md:pt-16 md:pb-28 overflow-hidden ${bgColor}`}>
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 lg:px-8 max-w-[1400px]">
