...
export default function ValuesGovernanceCorporateGovernance({ content }: ValuesGovernanceCorporateGovernanceProps) {
  ...
  return (
    <section ref={containerRef} className="py-24 relative overflow-hidden bg-slate-900 border-y border-slate-800">
      {/* Parallax Background */}
      {bgImage && (
        <motion.div
          style={{ y, backgroundImage: `url(${bgImage})` }}
          className="absolute inset-x-0 -top-[20%] h-[140%] w-full bg-cover bg-center brightness-[0.35] contrast-125 grayscale-20"
        />
      )}
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-10 shadow-2xl"
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/20 text-white border border-primary/30 text-xs font-bold uppercase tracking-widest mb-6">
          ...
          >
            <div className="grid grid-cols-2 gap-4 lg:gap-6 relative z-10">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center gap-4 shadow-xl hover:bg-white/20 hover:border-primary/50 transition-all duration-300 text-center group cursor-default"
                >
            ...
            >
              <div className="relative">
                ...
                <div className="w-24 h-24 rounded-2xl bg-linear-to-br from-primary to-rose-600 border-2 border-white/20 flex items-center justify-center shadow-2xl relative z-10">
