...
export default function ValuesGovernanceCommitment({
  content,
}: ValuesGovernanceCommitmentProps) {
  const {
    ...
    <section className="py-10 md:py-16 bg-white relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div
            className="absolute inset-0 rounded-3xl border border-primary/20 animate-ping opacity-20"
        ...
        >
          {[
            ...
            >
              ...
              <p className="text-4xl lg:text-5xl font-extrabold text-primary mb-3 tracking-tight group-hover:scale-105 transition-transform duration-500 origin-bottom-left">
                {stat.value}
              </p>
              <p className="text-base text-slate-500 font-medium group-hover:text-slate-700 transition-colors uppercase tracking-wider">
                {stat.label}
              </p>
            </div>
          ))}
