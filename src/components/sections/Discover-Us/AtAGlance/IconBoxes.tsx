...
export default function IconBoxes({ content }: IconBoxesProps) {
  ...
  const boxes: BoxContent[] = [
    {
      icon: content?.box1Icon || defaultBoxes[0].icon,
      title: content?.box1Title || defaultBoxes[0].title,
      description: content?.box1Description || defaultBoxes[0].description
    },
    {
      icon: content?.box2Icon || defaultBoxes[1].icon,
      title: content?.box2Title || defaultBoxes[1].title,
      description: content?.box2Description || defaultBoxes[1].description
    },
    {
      icon: content?.box3Icon || defaultBoxes[2].icon,
      title: content?.box3Title || defaultBoxes[2].title,
      description: content?.box3Description || defaultBoxes[2].description
    }
  ];
