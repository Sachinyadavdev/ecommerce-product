            ...
            {track.map((logo, i) =>
              logo.href ? (
                <a
                  ...
                  className="cs-logo-wrap relative shrink-0 w-44 h-20 block"
                  tabIndex={-1}
                >
                  <Image
                    src={logo.src}
                    alt={logo.alt}
                    fill
                    className="cs-logo-img object-contain object-center"
                    unoptimized
                  />
                </a>
              ) : (
                <span key={`${logo.id}-${i}`} className="cs-logo-wrap relative shrink-0 w-44 h-20 block">
                  <Image
                    src={logo.src}
                    alt={logo.alt}
                    fill
