...
export default function AutomationHero({ content }: AutomationHeroProps) {
  const {
    title = "Automation & Technology at Besmak",
    subtitle = "ADVANCED MANUFACTURING | ROBOTIC INTEGRATION | PRECISION CONTROL",
    bgImage = "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1600&auto=format&fit=crop",
  } = content || {};
