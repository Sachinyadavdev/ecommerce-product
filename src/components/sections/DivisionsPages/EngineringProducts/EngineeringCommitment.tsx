    ...
    <section className="py-24 md:py-32 bg-slate-50 site-content relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-5xl text-center relative z-10">
        <motion.div
          ...
          className="relative bg-white/80 backdrop-blur-xl p-10 md:p-16 lg:p-20 rounded-[3rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-white/50 overflow-hidden"
        >
          {/* Subtle Inner Glow */}
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-xl md:text-2xl text-slate-600 font-normal leading-relaxed max-w-3xl mx-auto italic">
              "{description}"
            </motion.p>
          </motion.div>
        </motion.div>
