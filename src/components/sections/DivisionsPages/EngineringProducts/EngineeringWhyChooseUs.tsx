...
export default function EngineeringWhyChooseUs({ content }: EngineeringWhyChooseUsProps) {
  ...
  return (
    <section className="relative py-24 md:py-32 bg-primary text-white site-content overflow-hidden">
        ...
        >
          {points.map((point, idx) => {
            ...
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="relative p-8 md:p-10 rounded-[2rem] bg-white/8 backdrop-blur-xl border border-white/10 flex flex-col h-full group hover:bg-white/12 hover:border-white/20 transition-all duration-500 shadow-xl overflow-hidden"
            >
              {/* Card Inner Glow */}
