          ...
          <motion.div variants={imageVariants} className="relative w-full order-2 lg:order-1 h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center">
            ...
            >
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  <h4 className="text-xl md:text-2xl font-black text-slate-900 leading-none">Smart</h4>
                  <p className="text-[10px] md:text-xs text-primary font-bold uppercase tracking-widest mt-1">Manufacturing</p>
                </div>
              </div>
            ...
            <motion.div variants={itemVariants} className="space-y-6 pt-8 border-t border-slate-200">
              {features.map((feature, idx) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-slate-900 mb-1 group-hover:text-primary transition-colors">{feature.title}</h4>
