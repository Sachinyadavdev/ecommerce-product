...
export default function EngineeringProducts({ content }: EngineeringProductsProps) {
  ...
  return (
    <section className="py-24 md:py-32 bg-slate-50 relative site-content overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-stretch">
          ...
          >
            <div className="h-full bg-slate-900 rounded-[2.5rem] p-10 lg:p-12 relative overflow-hidden shadow-2xl flex flex-col justify-center group">
