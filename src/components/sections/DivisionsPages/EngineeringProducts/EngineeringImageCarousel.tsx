...
interface EngineeringImageCarouselProps {
  content?: {
    title?: string;
    subtitle?: string;
    [key: string]: any;
...
const defaultImages: CarouselImage[] = [
  ...
  { id: "2", src: "https://images.unsplash.com/photo-1537462715879-360eeb61a0ad?auto=format&fit=crop&q=80&w=1200", alt: "Industrial Engineering Excellence" },
  { id: "3", src: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=1200", alt: "Manufacturing Precision Components" },
  { id: "4", src: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=1200", alt: "Automated Assembly Lines" }
];

export default function EngineeringImageCarousel({ content }: EngineeringImageCarouselProps) {
  ...
  const {
    title = "Advanced Precision Capabilities",
    subtitle = "Our High-Performance Infrastructure",
  } = content || {};
